...
<body>
	...
	<div style="width: 80%;margin-left: 10%;">
		...
		<ul id="top_right" class="collapse navbar-collapse nav navbar-nav navbar-right"	style="margin-right: 20px;">
			<li>
				<a href="#">
					<span class="badge"	style="font-size: 16px;background: #F8F8F8;color: blue">${admin.username}</span>
				</a>
			</li>
			<li>
				<a href="/xiaomi/admin?method=loginOut">
		...
		<div id="left_tab" style="margin-top: 70px;" class="collapse navbar-default navbar-collapse">
			<ul class="nav panel-group" id="myPanel">
				...
				<li class="panel">
					<a href="#sub5" data-toggle="collapse" data-parent="#myPanel"> 积分管理
						<span class="glyphicon glyphicon-triangle-bottom pull-right"></span>
					</a>
					<ul id="sub5" class="nav panel-collapse collapse">
						<li>
							<a href="#" id="showScore">
								<span class="glyphicon glyphicon-record"></span>&nbsp;&nbsp;查看积分
							</a>
						</li>
					</ul>
				</li>
		...
		<div class="page_main">
			<script type="text/javascript">
				$("#showUser").click(function(){
					$(".dv_content").attr("src","/xiaomi/admin?method=listUser");
				})
				$("#showGoodsType").click(function(){
					$(".dv_content").attr("src","/xiaomi/goodsType?method=showGoodsType");
				})
				$("#addGoodsType").click(function(){
					$(".dv_content").attr("src","/xiaomi/goodsType?method=jumpAddGoodsType");
				})
				$("#showGoods").click(function(){
					$(".dv_content").attr("src","/xiaomi/goods?method=showGoods");
				})
				$("#addGoods").click(function(){
					$(".dv_content").attr("src","/xiaomi/goods?method=jumpAddGoods");
				})
				$("#showOrder").click(function(){
					$(".dv_content").attr("src","/xiaomi/order?method=showOrder");
				})
